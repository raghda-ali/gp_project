...
class MyProductsByID extends StatelessWidget {
  static String id = 'MyProductsByID';
                                        ...
                                        Row(
                                          ...
                                          children: <Widget>[
                                            CircleAvatar(
                                              backgroundColor:
                                                  Color(0xFFD9D9D9),
                                       backgroundImage: NetworkImage('${MyProductByID[index].pImage}'),
                                              radius: 36.0,
                                            ),
                                            SizedBox(
                                              width: 10.0,
                                                ...
                                                RichText(
                                                  text: TextSpan(
                                                    ...
                                                    children: <TextSpan>[
                                                      ...
                                                      TextSpan(
                                                        text:
                                                            '\n ${MyProductByID[index].pDescription}',
                                                        style: TextStyle(
