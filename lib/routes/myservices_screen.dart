                          ...
                          children: <Widget>[
                            CircleAvatar(
                              ...
                              backgroundImage: NetworkImage(
                                  'https://hopeacademyegypt.com/wp-content/uploads/2020/05/hope-logo.png'),
                              radius: 36.0,
                            ),
                            SizedBox(
                              width: 10.0,
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      RaisedButton(
                                        onPressed: () {
                                          Scaffold.of(context).showSnackBar(SnackBar(content: Text('Sure You want delete this service ??'),
                                          backgroundColor: KMainColor,
